...
<div class="row">
    <div class="col-12 mb-3">
        <a href="{{ route('frequencia.turmas') }}" class="mb-4"><i class="fas fa-chalkboard-teacher"></i> Voltar para frequências</a>
    </div>
</div>
<div class="row mb-3">
  <div class="col-12">
...
<form class="row g-3" action="{{ route('corrigir.frequecia.turmas',['idTurma'=>$frequencia->id_turma,'idFrequencia'=>frequencia->id]) }}" method="POST">
    @csrf
    <input type="hidden" value="{{ $frequencia->id }}" name="idFrequencia">
    <input type="hidden" value="{{ $frequencia->id_turma }}" name="idTurma">

    <div class="col-md-6">
      <label for="nome" class="form-label">Nome<span class="text-danger">*</span></label>
      <input type="text" maxlength="128" class="form-control @error("nome") is-invalid @enderror" value="{{ $frequencia->nome_servidor }}" name="nome"  id="nome">
      @error('nome')
