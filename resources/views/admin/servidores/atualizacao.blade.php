...
<div class="row justify-content-center">
  ...
  @endif
<form class="row g-3" action="{{ route('update.cadastros',['idServidor'=>$servidor->id]) }}" method="POST">
    @csrf
    <div class="col-md-6">
      <label for="nome" class="form-label">Nome</label>
      <input type="text" maxlength="128" class="form-control" name="nome" value="{{ $servidor->nome }}" id="nome">
    </div>
    <div class="col-md-3">
      <label for="cpf" class="form-label">CPF</label>
      <input type="text" maxlength="11" class="form-control cpf" name="cpf" id="cpf" value="{{ $servidor->cpf }}">
    </div>
    <div class="col-md-3">
